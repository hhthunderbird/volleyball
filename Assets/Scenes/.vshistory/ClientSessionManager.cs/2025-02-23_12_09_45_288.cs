...
public class ClientSessionManager : NetworkBehaviour
{
    ...
    public void SpawnPlayersRpc()
    {
        ...
        foreach ( var client in NetworkManager.Singleton.ConnectedClientsList )
        {
            ...
            GameObject playerInstance = Instantiate( _playerPrefab, spawnPoint.position, Quaternion.identity );
            NetworkObject netObj = playerInstance.GetComponent<NetworkObject>();

            netObj.SpawnWithOwnership( client.ClientId ); // Assigns ownership to the correct client
        }
