...
public class PlayerController : NetworkBehaviour
{
    ...
    private void OnCollisionEnter( Collision collision )
    {
        ...
        {
            RequestOwnerShipRpc( collision.gameObject, NetworkManager.Singleton.LocalClientId );
        }
    }

    [Rpc( SendTo.Server )]
    private void RequestOwnerShipRpc( GameObject obj, ulong id ) 
    {
        var nobj = obj.GetComponent<NetworkObject>();
        nobj.ChangeOwnership( id ); 
    }
