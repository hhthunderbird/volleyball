...
public class JoinGameUI : MonoBehaviour
{
    ...
    public async UniTask<QueryResponse> CheckIfSessionExistsByName( string sessionName, CancellationTokenSource cancellationTokenSource )
    {
        try
        {
            ...
            return LobbyService.Instance.QueryLobbiesAsync( query ).AsUniTask();
