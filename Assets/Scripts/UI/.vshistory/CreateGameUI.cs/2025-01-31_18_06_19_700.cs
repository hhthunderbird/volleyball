...
public class CreateGameUI : MonoBehaviour
{
    ...
    private void RoomNameInputListener( string value )
    {
        ...
        {
            roomName = ( ( int ) Random.value * 1000 ).ToString();
        }
    ...
    private void PlayerCountSliderListener(float value )
    {
        ...
        _playerCountSliderText.text = quantity.ToString();

        PlayerPrefs.SetString( PlayerPrefsKeys.RoomPlayersQuantity.ToString(), quantity );
        PlayerPrefs.Save();
    }
