...
public class ImageSelectionUI : MonoBehaviour
{
    ...
    private void Start()
    {
        pngFileType = NativeFilePicker.ConvertExtensionToFileType( "pdf" ); // Returns "application/pdf" on Android and "com.adobe.pdf" on iOS
        Debug.Log( "pdf's MIME/UTI is: " + pngFileType );
