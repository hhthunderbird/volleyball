...
public class GridManager : NetworkBehaviour
{
    ...
    private void BuildGrid()
    {
        ...
        var verticalSize = (int)(_mainImage.height / horizontalSize);
        var finalVerticalSize = _mainImage.height / ( float ) verticalSize;
    ...
    {
        //int horizontal = 15;
        //var horizontalSize = _mainImage.width / (float)horizontal;

        //var absVerticalSize = _mainImage.height / horizontalSize;
        //var finalVerticalSize = _mainImage.height / ( float ) absVerticalSize;
        //var verticalScale = finalVerticalSize / horizontalSize;
