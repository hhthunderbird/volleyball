...
public class GridManager : NetworkBehaviour
{
    ...
    private Dictionary<MaskType, Texture2D> _maskTiles = new();
    ...
    {
        _maskTiles.Add( MaskType.TL, _topLeftCorner );
        _maskTiles.Add( MaskType.TR,_topRightCorner );
        _maskTiles.Add( MaskType.BL,_bottomLeftCorner );
        _maskTiles.Add( MaskType.BR,_bottomRightCorner );

        _maskTiles.Add( MaskType.B,_bottom );
        _maskTiles.Add( MaskType.T,_top );
        _maskTiles.Add( MaskType.L,_left );
        _maskTiles.Add( MaskType.R, _right );
        _maskTiles.Add( MaskType.C, _center);
    }
