...
{
    [SerializeField] private NetworkRunnerInstance _networkRunner;
    ...
    void Start()
    {
        ...
        _networkRunner.OnSceneLoad += OnSceneLoad;
    }
    ...
    private void Do()
    {
        ...
        for ( int y = 0; y < _height; y++ )
        {
            for ( int x = 0; x < _length; x++ )
            {
                ...
                var piece = _networkRunner.Runner.Spawn( _piece, position, Quaternion.identity, null  );
