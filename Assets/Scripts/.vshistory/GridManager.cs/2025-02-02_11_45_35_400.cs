...
public class GridManager : NetworkBehaviour
{
    ...
    private void BuildGrid()
    {
        ...
        Length = 15;
        var horizontalSize = _mainImage.width / ( float ) Length;

        Height = ( int ) ( _mainImage.height / horizontalSize );
    ...
    private void InstantiateBlock( int x, int y, Vector2 scale )
    {
        ...
        var hOffsetStart = 1f / Length / -2f;
        var vOffsetStart = 1f / Height / -2f;

        var hOffset = 1f / Length;
        var vOffset = 1f / Height;

        var vTiling = 1f / Height * 2;
        var hTiling = 1f / Length * 2;
