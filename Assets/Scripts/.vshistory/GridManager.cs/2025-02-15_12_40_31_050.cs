...
public class GridManager : NetworkBehaviour
{
    ...
    private NetworkVariable<int> _textureIndex = new NetworkVariable<int>(default, NetworkVariableReadPermission.Everyone, NetworkVariableWritePermission.Owner );
    ...
    private void BuildGrid()
    {
        ...
        _textureIndex.Value = PlayerPrefs.GetInt(PlayerPrefsKeys.TextureId.ToString());
        var baseMap = TextureManager.Instance.GetTexture( _textureIndex.Value );
    ...
    private void InstantiateBlock( int x, int y, Vector2 scale )
    {
        ...
        piece.MainTextureIndex = PlayerPrefs.GetInt(PlayerPrefsKeys.TextureId.ToString());
