...
public class GridManager : NetworkBehaviour
{
    ...
    private void SetDictionary()
    {
        ...
        maskTiles.Add( MaskType.TL, _topLeftCorner );
        maskTiles.Add( MaskType.TR,_topRightCorner );
        maskTiles.Add( MaskType.BL,_bottomLeftCorner );
        maskTiles.Add( MaskType.BR,_bottomRightCorner );

        maskTiles.Add( MaskType.B,_bottom );
        maskTiles.Add( MaskType.T,_top );
        maskTiles.Add( MaskType.L,_left );
        maskTiles.Add( MaskType.R, _right );
        maskTiles.Add( MaskType.C, _center);
    }
