...
public class GridManager : MonoBehaviour
{
    ...
    [SerializeField] private List<GameObject> _createdPieces = new List<GameObject>();
    [SerializeField] private Transform _bgPiece;
    [SerializeField] private List<GameObject> _createdBGPieces = new List<GameObject>();
