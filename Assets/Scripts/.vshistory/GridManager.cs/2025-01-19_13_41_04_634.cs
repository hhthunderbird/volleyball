    ...
    private void Do()
    {
        ...
        for ( int x = 0; x < _height; x++ )
        {
            for ( int l = 0; l < _length; l++ )
            {
                ...
                var position = new Vector3( l * _sideSize, x * _sideSize, z );
                bgPiece.position = piece.transform.position = position;

                piece.OriginalLocation = new Vector3( l * _sideSize, x * _sideSize, z );
                ...
                var offset = new Vector2( l * horizontalTiling, x * verticalTiling );
