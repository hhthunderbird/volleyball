...
public class DragAndDropManager : MonoBehaviour
{
    ...
    void Update()
    {
        Vector2 mousePos = Camera.main.ScreenToWorldPoint( Input.mousePosition ); // Convert mouse position to world space [1, 11, 12]

        RaycastHit2D hit = Physics2D.Raycast( mousePos, Vector2.zero, Mathf.Infinity ); // Cast a ray from the mouse position [1, 12, 12]
