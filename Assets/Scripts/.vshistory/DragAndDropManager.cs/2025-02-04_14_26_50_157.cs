...
public class DragAndDropManager : NetworkBehaviour
{
    ...
    private void Update()
    {
        _input.PlayerInputData.InputPosition = Input.mousePosition;
    }
    ...
    public override void FixedUpdateNetwork()
    {
        if ( _currentObject != null )
        {
            ...
            Debug.Log( $"BBBBBBBBBBBBBBBBBB   {Input.mousePosition}" );
        ...
        if ( _input.PlayerInputData.Grabbed && _currentObject == null )
        {
            //Debug.Log( "GRABBED" );
            Grab();
        }
