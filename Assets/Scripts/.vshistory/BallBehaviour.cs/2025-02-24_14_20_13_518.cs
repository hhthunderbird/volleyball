...
public class BallBehaviour : NetworkBehaviour
{
    ...
    public NetworkVariable<Vector3> _ballPosition = new NetworkVariable<Vector3>( Vector3.zero, NetworkVariableReadPermission.Everyone, NetworkVariableWritePermission.Server );
    ...
    private void Update()
    {
        if ( IsServer )
        {
            ...
            _ballPosition.Value = transform.position;
        }
