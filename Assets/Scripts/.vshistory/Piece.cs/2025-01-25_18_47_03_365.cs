...
public struct PieceData
{
    ...
    public TileMask MaskTextureIndex;
    public Vector4 BaseMapModifiers;
    public Vector4 MaskModifiers;
}
...
public class Piece : NetworkBehaviour
{
    ...
    [Networked, OnChangedRender(nameof(OnPieceDataChange))] public PieceData PieceData { get; set; }
    ...
    private object OnPieceDataChange()
    {
        Debug.Log( "!!!!!!!!!!!!!!!!!!!!" );
    }
