Shader "Custom/FloorMark"
{
    Properties
    {
        ...
        _RingRadius("Min Ring Radius", Float) = 10.0
        _MinRingRadius("Min Ring Radius", Float) = 10.0
        _MaxRingRadius("Max Ring Radius", Float) = 10.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //float radius = _SinTime * 
                
                float step = pow( smoothstep(0, _RingRadius, dist), _RingSmoothing);
